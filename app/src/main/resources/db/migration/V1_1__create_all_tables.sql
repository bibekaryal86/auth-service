...
(
    ...
    CONSTRAINT uc_app_user_app_email UNIQUE (app, email)
);
...
-- admin table data
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'PERMISSION_CREATE', 'CAN ADD PERMISSION');
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'PERMISSION_READ', 'CAN VIEW PERMISSION');
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'PERMISSION_UPDATE', 'CAN EDIT PERMISSION');
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'PERMISSION_DELETE', 'CAN DELETE PERMISSION');
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'ROLE_CREATE', 'CAN ADD ROLE');
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'ROLE_READ', 'CAN VIEW ROLE');
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'ROLE_UPDATE', 'CAN EDIT ROLE');
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'ROLE_DELETE', 'CAN DELETE ROLE');
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'ROLE_PERMISSION_ASSIGN', 'CAN ADD PERMISSION TO ROLE');
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'ROLE_PERMISSION_UNASSIGN', 'CAN REMOVE PERMISSION FROM ROLE');
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'USER_CREATE', 'CAN ADD USER');
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'USER_READ', 'CAN VIEW USER');
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'USER_UPDATE', 'CAN EDIT USER');
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'USER_DELETE', 'CAN DELETE USER');
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'USER_ROLE_ASSIGN', 'CAN ADD ROLE TO USER');
INSERT INTO app_permission (app, name, description)
VALUES ('USER-MGMT-SYS', 'USER_ROLE_UNASSIGN', 'CAN REMOVE ROLE FROM USER');
