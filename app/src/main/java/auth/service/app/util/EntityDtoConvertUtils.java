...
public class EntityDtoConvertUtils {
  ...
  private AuditPermissionDto convertEntityToDtoPermissionAudit(
    ...
    final ProfileDto createdBy = null; // TODO
    final PermissionDto eventData =
        convertEntityToDtoPermission(
            auditPermissionEntity.getEventData(), null, Boolean.FALSE, Boolean.FALSE);
  ...
  private AuditRoleDto convertEntityToDtoRoleAudit(final AuditRoleEntity auditRoleEntity) {
    ...
    final ProfileDto createdBy = null; // TODO
    final RoleDto eventData = null; // TODO
  ...
  private AuditPlatformDto convertEntityToDtoPlatformAudit(
    ...
    final ProfileDto createdBy = null; // TODO
    final PlatformDto eventData = null; // TODO
  ...
  private AuditProfileDto convertEntityToDtoProfileAudit(
    ...
    final ProfileDto createdBy = null; // TODO
    final ProfileDto eventData = null; // TODO
  ...
  private PermissionDto convertEntityToDtoPermission(
    ...
    if (isIncludeExtras) {
      ...
      final List<PlatformRolePermissionDto> pprDtos =
          CommonUtilities.isEmpty(prpEntities)
              ? Collections.emptyList()
              : prpEntities.stream()
                  .map(
                      prpEntity -> {
                        final PlatformDto platformDto = null; // TODO
                        final RoleDto roleDto = null; // TODO
                  ...
                  .toList();
      dto.setPlatformRolePermissions(pprDtos);
    } else {
          ...
          CommonUtilities.isEmpty(pprEntities)
              ...
              : pprEntities.stream()
                  .map(
                      pprEntity -> {
                        final PlatformDto platformDto = null; // TODO
                        final ProfileDto profileDto = null; // TODO
