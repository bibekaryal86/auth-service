...
public class TestData {
    ...
    public static ProfileDto getProfileDto() {
        ...
        BeanUtils.copyProperties(
                profileEntity, profileDto, "password", "profileAddress");
        ...
        List<PlatformProfileRoleDto> pprDtos = List.of(PlatformProfileRoleDto.builder().platform(platformDto).profile(profileDto).role(roleDto).build());
    ...
    public static ProfileDto getProfileDtoWithSuperUserRole(final ProfileDto profileDtoInput) {
        ...
        List<PlatformProfileRoleDto> pprDtos = List.of(PlatformProfileRoleDto.builder().platform(platformDto).profile(profileDtoOutput).role(roleDto).build());
    ...
    public static PlatformProfileRoleEntity getPlatformProfileRoleEntity(
            PlatformEntity platformEntity, ProfileEntity profileEntity, RoleEntity roleEntity, LocalDateTime unassignedDate) {
    ...
    public static PlatformRolePermissionEntity getPlatformRolePermissionEntity(
            PlatformEntity platformEntity, RoleEntity roleEntity, PermissionEntity permissionEntity, LocalDateTime unassignedDate) {
    ...
    public static List<PlatformProfileRoleEntity> getPlatformProfileRoleEntities() {
        ...
        platformProfileRoleEntities.add(
                getPlatformProfileRoleEntity(
                        platformEntities.get(0), profileEntities.get(2), roleEntities.get(2), LocalDateTime.now()));
        // 5, 5, 5
        platformProfileRoleEntities.add(
                getPlatformProfileRoleEntity(
        ...
        platformProfileRoleEntities.add(
                getPlatformProfileRoleEntity(
                        platformEntities.get(4), profileEntities.get(6), roleEntities.get(6), LocalDateTime.now()));
        ...
        platformProfileRoleEntities.add(
                getPlatformProfileRoleEntity(
                        platformEntities.get(8), profileEntities.get(8), roleEntities.get(8), LocalDateTime.now()));
    ...
    public static List<PlatformRolePermissionEntity> getPlatformRolePermissionEntities() {
        ...
        platformRolePermissionEntities.add(
                getPlatformRolePermissionEntity(
                        platformEntities.get(0), roleEntities.get(2), permissionEntities.get(2), LocalDateTime.now()));
        // 5, 5, 5
        platformRolePermissionEntities.add(
                getPlatformRolePermissionEntity(
        ...
        platformRolePermissionEntities.add(
                getPlatformRolePermissionEntity(
                        platformEntities.get(4), roleEntities.get(6), permissionEntities.get(6), LocalDateTime.now()));
        ...
        platformRolePermissionEntities.add(
                getPlatformRolePermissionEntity(
                        platformEntities.get(8), roleEntities.get(8), permissionEntities.get(8), LocalDateTime.now()));
    ...
    public static AuthToken getAuthToken() {
        return new AuthToken(
                ...
                List.of(new AuthToken.AuthTokenPermission(1L, "Permission 1")), Boolean.FALSE
        );
    }

    public static AuthToken getAuthTokenWithPermissions(List<String> permissionNames) {
        final AuthToken authToken = getAuthToken();
        final List<AuthToken.AuthTokenPermission> permissions = IntStream.range(0, permissionNames.size())
                .mapToObj(
                        i -> new AuthToken.AuthTokenPermission(i, permissionNames.get(i))).toList();
