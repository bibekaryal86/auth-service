...
public class EntityDtoConvertUtilsTest extends BaseTest {
  ...
  //              .orElse(null);
  //      AppsDto appsDto =
  //          appsDtos.stream().filter(x -> x.getId().equals("app-" +
  // finalI)).findFirst().orElse(null);
  ...
  //          appPermissionEntities.stream().filter(x -> x.getId() ==
  // finalI).findFirst().orElse(null);
  //      AppPermissionDto appPermissionDto =
  ...
  //    AppRoleDto appRoleDto = entityDtoConvertUtils.convertEntityToDtoAppRole(appRoleEntity,
  // true);
  //
  ...
  //              .filter(y -> Objects.equals(y.getAppRole().getId(),
  // appRoleDtos.getFirst().getId()))
  //              .findFirst()
  //              .orElse(null);
  ...
  //    ResponseEntity<AppRoleResponse> response =
  // entityDtoConvertUtils.getResponseSingleAppRole(null);
  //
  //    assertNotNull(response);
  //    assertNotNull(response.getBody());
  ...
  //      assertEquals(
  //          appUserAddressEntity.get().getAddressType(),
  // appUserAddressDto.get().getAddressType());
  ...
  //            appUserAddressEntity.get().getAddressType(),
  // appUserAddressDto.get().getAddressType());
  //        assertEquals(appUserAddressEntity.get().getStreet(),
  // appUserAddressDto.get().getStreet());
  //      }
  //
  //      // check roles and permissions
  ...
  //    ResponseEntity<AppUserResponse> response =
  // entityDtoConvertUtils.getResponseSingleAppUser(null);
  //
  //    assertNotNull(response);
  //    assertNotNull(response.getBody());
  ...
  //
  //    // check dto against entity
  //    assertEquals(appRolePermissionDto.getAssignedDate(),
  // appRolePermissionEntity.getAssignedDate());
  //    assertEquals(
  ...
  //        entityDtoConvertUtils.getResponseErrorProfilePassword(new
  ...
  //        entityDtoConvertUtils.getResponseErrorResponseStatusInfo(new
  ...
  //    assertNotNull(response.getHeaders().getLocation());
  //    assertEquals(HttpStatus.FOUND, response.getStatusCode());
  //    assertEquals(redirectUrl + "?is_reset=false",
  // response.getHeaders().getLocation().toString());
  //  }
  //
  //  @Test
