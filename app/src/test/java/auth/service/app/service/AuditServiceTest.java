...
public class AuditServiceTest extends BaseTest {
  ...
  //    assertEquals(AuditEnums.AuditPermissions.CREATE_PERMISSION.name(),
  // actualEntity.getEventType());
  //  }
  //
  //  @Test
  //  void testAuditAppPermissionUpdate() {
  //    assertDoesNotThrow(() -> auditService.auditAppPermissionUpdate(request,
  // appPermissionEntity));
  //
  //    ArgumentCaptor<AuditAppPermissionEntity> entityCaptor =
  //        ArgumentCaptor.forClass(AuditAppPermissionEntity.class);
  ...
  //
  //    AuditAppPermissionEntity actualEntity = entityCaptor.getValue();
  //    assertEquals(AuditEnums.AuditPermissions.UPDATE_PERMISSION.name(),
  // actualEntity.getEventType());
  //  }
  //
  //  @Test
  ...
  //    assertDoesNotThrow(() -> auditService.auditAppRoleDeleteSoft(request,
  // appRoleEntity.getId()));
  //
  //    ArgumentCaptor<AuditAppRoleEntity> entityCaptor =
  //        ArgumentCaptor.forClass(AuditAppRoleEntity.class);
  ...
  //    assertDoesNotThrow(() -> auditService.auditAppRoleDeleteHard(request,
  // appRoleEntity.getId()));
  //
  //    ArgumentCaptor<AuditAppRoleEntity> entityCaptor =
  //        ArgumentCaptor.forClass(AuditAppRoleEntity.class);
  ...
  //
  //    ArgumentCaptor<AuditAppsEntity> entityCaptor =
  // ArgumentCaptor.forClass(AuditAppsEntity.class);
  ...
  //    assertDoesNotThrow(
  //        () -> auditService.auditAppUserCreate(request, appsEntity.getId(), appUserEntity,
  // true));
  //
  ...
  //    assertEquals(AuditEnums.AuditUsers.CREATE_USER.name(),
  // actualEntities.get(0).getEventType());
  //    assertEquals(AuditEnums.AuditUsers.ASSIGN_APP.name(), actualEntities.get(1).getEventType());
  //    assertEquals(AuditEnums.AuditUsers.ASSIGN_ROLE.name(),
  // actualEntities.get(2).getEventType());
  //    assertEquals(
  ...
  //
  //    AuditAppUserEntity actualEntity = entityCaptor.getValue();
  //    assertEquals(AuditEnums.AuditUsers.UPDATE_USER_PASSWORD.name(),
  // actualEntity.getEventType());
  //  }
  //
  //  @Test
  ...
  //    assertDoesNotThrow(() -> auditService.auditAppUserDeleteSoft(request,
  // appUserEntity.getId()));
  //
  //    ArgumentCaptor<AuditAppUserEntity> entityCaptor =
  //        ArgumentCaptor.forClass(AuditAppUserEntity.class);
  ...
  //    assertDoesNotThrow(() -> auditService.auditAppUserDeleteHard(request,
  // appUserEntity.getId()));
  //
  //    ArgumentCaptor<AuditAppUserEntity> entityCaptor =
  //        ArgumentCaptor.forClass(AuditAppUserEntity.class);
  ...
  //    assertDoesNotThrow(
  //        () -> auditService.auditAppUserLogoutSuccess(request, appsEntity.getId(),
  // appUserEntity));
  //
  //    ArgumentCaptor<AuditAppUserEntity> entityCaptor =
  //        ArgumentCaptor.forClass(AuditAppUserEntity.class);
  ...
  //    assertDoesNotThrow(
  //        () -> auditService.auditAppUserResetSuccess(request, appsEntity.getId(),
  // appUserEntity));
  //
  //    ArgumentCaptor<AuditAppUserEntity> entityCaptor =
  //        ArgumentCaptor.forClass(AuditAppUserEntity.class);
  ...
  //    assertDoesNotThrow(
  //        () -> auditService.auditAppUserValidateInit(request, appsEntity.getId(),
  // appUserEntity));
  //
  //    ArgumentCaptor<AuditAppUserEntity> entityCaptor =
  //        ArgumentCaptor.forClass(AuditAppUserEntity.class);
  ...
  //    assertDoesNotThrow(
  //        () -> auditService.auditAppUserValidateExit(request, appsEntity.getId(),
  // appUserEntity));
  //
  //    ArgumentCaptor<AuditAppUserEntity> entityCaptor =
  //        ArgumentCaptor.forClass(AuditAppUserEntity.class);
