...
public class RoleControllerTest extends BaseTest {
  ...
  //        TestData.getAppUserDtoWithPermission(PLATFORM_ID, "ROLE_CREATE",
  ...
  //    appUserDtoWithPermission =
  //        TestData.getAppUserDtoWithPermission(PLATFORM_ID, "ROLE_UPDATE",
  // appUserDtoNoPermission);
  //    String bearerAuthCredentialsWithPermission =
  //        TestData.getBearerAuthCredentialsForTest(PLATFORM_ID, appUserDtoWithPermission);
  //
  ...
  //    appUserDtoWithPermission =
  //        TestData.getAppUserDtoWithPermission(PLATFORM_ID, "ROLE_DELETE",
  // appUserDtoNoPermission);
  //    String bearerAuthCredentialsWithPermission =
  //        TestData.getBearerAuthCredentialsForTest(PLATFORM_ID, appUserDtoWithPermission);
  //
