...
public class PlatformProfileRoleControllerTest extends BaseTest {
  ...
  //        TestData.getAppUserDtoWithPermission(PLATFORM_ID, "USER_ROLE_ASSIGN",
  ...
  //        webTestClient
  //            .get()
  //            .uri(String.format("/api/v1/app_users_roles/user_role/%s/%s", APP_USER_ID,
  // APP_ROLE_ID))
  //            .header("Authorization", "Bearer " + bearerAuthCredentialsWithPermission)
  //            .exchange()
  //            .expectStatus()
  ...
  //        appUserRoleRepository.save(TestData.getNewAppUserRoleEntity(appUserEntity,
  // appRoleEntity));
  //
  //    appUserDtoWithPermission =
  //        TestData.getAppUserDtoWithPermission(PLATFORM_ID, "USER_ROLE_UNASSIGN",
  // appUserDtoNoPermission);
  //    String bearerAuthCredentialsWithPermission =
  //        TestData.getBearerAuthCredentialsForTest(PLATFORM_ID, appUserDtoWithPermission);
  //
