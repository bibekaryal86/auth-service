...
public class ProfileControllerTest extends BaseTest {
    ...
    static void setUpBeforeAll() {
        ...
        ProfileDto profileDtoWithPermission = TestData.getProfileDtoWithSuperUserRole(profileDtoNoPermission);

        bearerAuthCredentialsNoPermission = TestData.getBearerAuthCredentialsForTest(platformEntity, profileDtoNoPermission);
        bearerAuthCredentialsWithPermission = TestData.getBearerAuthCredentialsForTest(platformEntity, profileDtoWithPermission);
    }
    ...
    void testUpdateProfileEmail_SuccessSuperUser() {
        ProfileEmailRequest profileEmailRequest = new ProfileEmailRequest("firstlast@four.com", "lastfirst@four.com");
    ...
    void testSoftDeleteProfile_Success() {
        ...
        assertNotNull(profileResponse);
        assertNotNull(profileResponse.getResponseMetadata());
        assertEquals(1, profileResponse.getResponseMetadata().getResponseCrudInfo().getDeletedRowsCount());
    ...
    void testRestoreProfile_Success() {
        ...
        assertNotNull(profileResponse);
        assertEquals(1, profileResponse.getProfiles().size());
        assertEquals(1, profileResponse.getResponseMetadata().getResponseCrudInfo().getRestoredRowsCount());
