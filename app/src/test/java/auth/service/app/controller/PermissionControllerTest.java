...
public class PermissionControllerTest extends BaseTest {
  ...
  //        TestData.getAppUserDtoWithPermission(PLATFORM_ID, "PERMISSION_CREATE",
  ...
  //    appUserDtoWithPermission =
  //        TestData.getAppUserDtoWithPermission(PLATFORM_ID, "PERMISSION_READ",
  // appUserDtoNoPermission);
  //    String bearerAuthCredentialsWithPermission =
  //        TestData.getBearerAuthCredentialsForTest(PLATFORM_ID, appUserDtoWithPermission);
  //
  ...
  //    appUserDtoWithPermission =
  //        TestData.getAppUserDtoWithPermission(PLATFORM_ID, "PERMISSION_UPDATE",
  // appUserDtoNoPermission);
  //    String bearerAuthCredentialsWithPermission =
  //        TestData.getBearerAuthCredentialsForTest(PLATFORM_ID, appUserDtoWithPermission);
  //
  ...
  //    appUserDtoWithPermission =
  //        TestData.getAppUserDtoWithPermission(PLATFORM_ID, "PERMISSION_DELETE",
  // appUserDtoNoPermission);
  //    String bearerAuthCredentialsWithPermission =
  //        TestData.getBearerAuthCredentialsForTest(PLATFORM_ID, appUserDtoWithPermission);
  //
  ...
  //        webTestClient
  //            .patch()
  //            .uri(String.format("/api/v1/app_permissions/permission/%s/restore",
  // APP_PERMISSION_ID))
  //            .header("Authorization", "Bearer " + bearerAuthCredentialsWithPermission)
  //            .exchange()
  //            .expectStatus()
